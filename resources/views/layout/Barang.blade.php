        ...
        <div class="nav h-full w-48">
            <div class="nav-back">
                ...
                <div class="nav-menu text-white1">
                    <div class="nav-txt pt-9 "><button class="w-full h-10 rounded-md text-start hover:border hover:text-white "><a href="dashboard" class="pl-3 w-full h-full"><i class='bx bxs-user-rectangle'></i>User</a></button></div>
                    <div class="nav-txt "><button class=" w-full h-12 rounded-md text-start border text-white"><p class="pl-3"><i class='bx bx-cart'></i>Barang</p></button></div>
        ...
        <div class="main-back">
            <div class="main-menu">
                ...
                <div class="flex">
                    <div class="main-grafik w-5/12 h-48">
                        <div class="chart-container ">
                            <canvas id="pieChart" class=" max-h-48 w-full text-start gap-11"></canvas> <!-- Adjust size and center the chart -->
                        </div>
                        <script>
                ...
                <div class="grafik-barang flex flex-wrap">
                    ...
                    <button class="m-2  bg-white border-2 border-black rounded-lg shadow-md shadow-black w-44 h-14"><p class="font-semibold text-xl text-left pl-2">{{ $chart->nama_barang }}: {{ $chart->stok }}</p></button>
            ...
            <div class="ad">
                <div class="btn">
                    <button class=" ml-6 bg-blue-400 hover:bg-blue-600 p-1 rounded"><a class=" p-1 font-semibold" href="adbarang"><i class='bx bx-plus'></i>add data</a></button>
                </div>
            </div>
                ...
                <div class="main-tabel flex justify-center overflow-y-auto scrollbar-hide h-52">
                    <table class="w-[99%] table-fixed ">
                        ...
                        <tbody>
                            ...
                            <td class=" border-b-2 border-black h-9"><button class="  bg-amber-500 hover:bg-amber-600 p-1 rounded transition transform hover:scale-95"><a class=" p-1 font-semibold" href="{{ route('barang.edit', $list->id_barang ) }}">Update</a></button></td>
