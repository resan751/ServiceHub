        ...
        <div class="nav h-full w-48">
            <div class="nav-back">
                ...
                <div class="nav-menu text-white1">
                    <div class="nav-txt pt-9 "><button class="w-full h-12 rounded-md text-start border text-white"><p class="pl-3"><i class='bx bxs-user'></i>User</p></button></div>
    ...
    <div class="main-back">
        ...
        <div class="flex">
            ...
            <div class="grafik-user justify-start ml-5 mt-7 flex">
                <p
                    class=" font-semibold text-2xl ml-2 mr-2 w-72 h-22 p-3 rounded-lg bg-white border-2 border-black shadow-lg shadow-red-600">
                    Total User: {{ $adminCount + $userCount }}
                </p>
                <p
                    class="  font-semibold text-2xl ml-2 mr-2 w-72 h-22 p-3 rounded-lg bg-white border-2 border-black shadow-lg shadow-admin">
                    admin: {{ $adminCount }}
                </p>
                <p
                    class="  font-semibold text-2xl ml-2 mr-2 w-72 h-22 p-3 rounded-lg bg-white border-2 border-black shadow-lg shadow-user">
                    User: {{ $userCount }}
                </p>
            </div>
        </div>
